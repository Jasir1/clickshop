                                            ...
                                            <div class="message_box" id="message_box">
                                                ...
                                                <!-- /////////////////////////////// -->
                                                    ...
                                                    ?>
                                                            ...
                                                            $sender_rs = Database::search("SELECT * FROM `user` INNER JOIN `profile_img` ON `user`.`email`=`profile_img`.`user_email` ");
                                                            ...
                                                            ?>
                                                                ...
                                                                ?>
                                                                    <div class="list-group rounded-0" onclick="viewAdminMessages('<?php echo $message_data['from']; ?>');">
                                                                        <a href="#" class="list-group-item list-group-item-action text-white rounded-0 message_unreaded">

                                                                            <div>
                                                                                <img src="<?php echo $sender_data["code"]; ?>" width="60px" class="rounded-circle" />
                                                                                <div class="me-4">
                                                                ...
                                                                ?>
                                                                    <div class="list-group rounded-0" onclick="viewAdminMessages('<?php echo $message_data['to']; ?>');">
                                                                        <a href="#" class="list-group-item list-group-item-action text-white rounded-0 message_unreaded">
                                                        ...
                                                        ?>
                                                            <?php
                                                            $user_rs = Database::search("SELECT * FROM `user` INNER JOIN `profile_img` ON `user`.`email`=`profile_img`.`user_email` WHERE `email`='" . $message_data["from"] . "' OR `email`='" . $message_data["to"] . "'");
                                                            $user_count = $user_rs->num_rows;
                                                            ...
                                                            ?>
                                                                ...
                                                                ?>
                                                                    <div class="list-group rounded-0" onclick="viewAdminMessages('<?php echo $message_data['from']; ?>');">
                                                                        <a href="#" class="list-group-item list-group-item-action text-white rounded-0 message_readed">
