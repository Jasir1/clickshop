...
<head>
    ...
    <title>Manage Users | clickShop</title>
        ...
        <section class="p-4 my-container nav-body">
            ...
            <div class="row m-2 my_div">
                <div class="col-12 pt-4">
                    <h2 class="text-center text-white">Manage Users</h2>
                </div>
                                ...
                                <div class="col-12 col-md-8 col-lg-6 m-auto mt-5">
                                    <div class="row">
                                        <div class="input-group mb-3">
                                            <input type="text" placeholder="Search user here..." class="form-control" aria-label="Text input with dropdown button" id="watchlist_search">
                                ...
                                <div class="col-11 mx-auto">
                                    <div class="row">
                                        <div class="col-5 mx-auto my_div rounded rounded-3 text-center">
                                            ...
                                            $ActiveUserrs = Database::search("SELECT COUNT(`status_id`) AS `count` FROM `user` WHERE `status_id`='1'");
                                            $ActiveUser = $ActiveUserrs->fetch_assoc();

                                            ?>
                                            <span class="text-white fw-bold fs-4">Active Users :</span>
                                            <span class="text-white fs-4"> <?php echo $ActiveUser["count"]; ?> </span>
                                        </div>
                                        <div class="col-5 mx-auto my_div rounded rounded-3 text-center">
                                            <?php

                                            $InactiveUserrs = Database::search("SELECT COUNT(`status_id`) AS `count` FROM `user` WHERE `status_id`='2'");
                                            $InactiveUser = $InactiveUserrs->fetch_assoc();

                                            ?>
                                            <span class="text-white fw-bold fs-4">Inactive Users :</span>
                                    ...
                                    <div class="col-11 mt-2">
                                        <div class="row">
                                            ...
                                            <?php
                                                ...
                                                ?>
                                                <div class="col-2 my_div border border-end rounded-3 py-2 d-none d-lg-block text-center">
                                                <img src="icons/user_default.png" style="height: 40px;" />
                                            </div>
                                                <?php
                                            }
                                            ...
                                            <div class="col-3 col-lg-2 my_div border border-end rounded-3 py-2">
                                                <span class="fs-6 fw-bold text-white"><?php echo $user_data["first_name"] . " " . $user_data["last_name"]; ?></span>
                                            </div>
                                            <div class="col-3 col-lg-2 my_div border border-end rounded-3 py-2 d-lg-block">
